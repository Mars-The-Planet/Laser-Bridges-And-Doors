...
public class FenceAttachedReceiverBlock extends AbstractAttachedReceiverBlock {
    ...
    public static final MapCodec<FenceAttachedReceiverBlock> CODEC = simpleCodec(FenceAttachedReceiverBlock::new);

    public FenceAttachedReceiverBlock(BlockBehaviour.Properties properties) {
        super(properties);
    }
