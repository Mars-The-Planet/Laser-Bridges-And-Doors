...
public class Laserbridges implements ModInitializer, ClientModInitializer {
    ...
    public void onInitialize() {
        ...
        Registry.register(BuiltInRegistries.ITEM, ResourceLocation.fromNamespaceAndPath(MOD_ID, BRIDGE_SOURCE_BLOCK_NAME), new BlockItem(BRIDGE_SOURCE_BLOCK, new Item.Properties()));

        Registry.register(BuiltInRegistries.BLOCK, ResourceLocation.fromNamespaceAndPath(MOD_ID, LASER_BLOCK_NAME), LASER_BLOCK);
        Registry.register(BuiltInRegistries.ITEM, ResourceLocation.fromNamespaceAndPath(MOD_ID, LASER_BLOCK_NAME), new BlockItem(LASER_BLOCK, new Item.Properties()));
        ...
        Registry.register(BuiltInRegistries.ITEM, ResourceLocation.fromNamespaceAndPath(MOD_ID, FENCE_SOURCE_BLOCK_NAME), new BlockItem(LASER_FENCE_SOURCE_BLOCK, new Item.Properties()));
        ...
        Registry.register(BuiltInRegistries.ITEM, ResourceLocation.fromNamespaceAndPath(MOD_ID, LASER_FENCE_BLOCK_NAME), new BlockItem(LASER_FENCE_BLOCK, new Item.Properties()));
